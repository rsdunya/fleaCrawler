 ...
 */
public class FleaCrawlControllerImpl implements FleaCrawlController {

    private static final Logger logger = LoggerFactory.getLogger(FleaCrawlControllerImpl.class);
